...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fgreek-financial-regulation-mcp.svg)](https://www.npmjs.com/package/@ansvar/greek-financial-regulation-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/greek-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add greek-financial-regulation-mcp --transport http https://mcp.ansvar.eu/greek-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "greek-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/greek-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/greek-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "greek-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/greek-financial-regulation-mcp"]
    }
  }
}
```
