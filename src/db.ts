/**
 * SQLite database access layer for the HCMC / Bank of Greece MCP server.
 *
 * Schema mirrors the Greek financial regulator document structure:
 *   - sourcebooks        — top-level document categories (HCMC_Apofaseis, HCMC_Egkyklioi, BOG_Praxeis_Dioikiti)
 *   - provisions         — individual decisions, circulars, and Governor's Acts
 *   - enforcement_actions — HCMC and BoG supervisory sanctions and measures
 *
