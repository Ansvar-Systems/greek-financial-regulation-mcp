...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across HCMC and Bank of Greece regulatory provisions. Returns matching decisions, circulars, and Governor's Acts.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Greek or English" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., HCMC_Apofaseis, BOG_Praxeis_Dioikiti). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., HCMC_Apofaseis)" },
  ...
  },
  {
    ...
    description: "List all HCMC and Bank of Greece sourcebook categories.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "gr_fin_search_enforcement",
    description:
      "Search HCMC and Bank of Greece enforcement actions — sanctions, fines, and revocations.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific HCMC or Bank of Greece provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
